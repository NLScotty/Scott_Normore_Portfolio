        ...
        <table class="table">
            ...
            <tbody>
                <c:forEach items="${users}" var="user">
                    <tr>
                        <td>${user.email}</td>
                        <td><a href="company?action=toggle&email=${user.email}">${user.active}</a></td>
                        <td>${user.firstName}</td>
                        <td>${user.lastName}</td>
                        <td>${user.role.roleName}</td>
                        <td>${user.companyId.companyName}</td>
                        <td><a href="company?action=edit&email=${user.email}">Edit</a></td>
                        <td><a href="company?action=delete&email=${user.email}">Delete</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
