...
CREATE TABLE IF NOT EXISTS `inventorydb`.`user` (
  ...
  `two_factor_number` INT(6),
  `company_id` INT(11),
  `session_password_uuid` VARCHAR(50),
  `link_password_uuid` VARCHAR(50),
  `registration_uuid` VARCHAR(50),
  PRIMARY KEY (`email`),
...
INSERT INTO `company` (`company_name`) VALUES ('Aperture Science');
INSERT INTO `company` (`company_name`) VALUES ('Umbrella Corpriation');
INSERT INTO `company` (`company_name`) VALUES ('Deep Rock Galactic');
...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`,`company_id`)
	VALUES ('cprg352+admin2@gmail.com', true, 'Admin2','Admin2', 'password', 3, 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('cprg352+anne@gmail.com', true, 'Anne','Annerson', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('cprg352+barb@gmail.com', true, 'Barb','Barber', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`, `two_factor_enabled`, `company_id`)
	VALUES ('cprg352+bill@gmail.com', true, 'Billy','Bob', 'password', 2, 1, 1);
